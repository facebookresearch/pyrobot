...
void EffortJointImpedanceController::jointCmdCallback(const franka_control_msgs::JointCommandConstPtr& msg) {

  if (msg->mode == franka_control_msgs::JointCommand::IMPEDANCE_MODE){
