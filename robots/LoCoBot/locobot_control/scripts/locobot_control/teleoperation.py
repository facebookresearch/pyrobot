        ...
        while True:
            ...
            if key is None:
                if self.is_robot_moving and \
                    ...
                    if self.cmd_prev in [self.cfg['KEY_POS_J5'], self.cfg['KEY_NEG_J5']]:
                        self.pub_stop_j5.publish()
                    elif self.cmd_prev in [self.cfg['KEY_POS_J4'], self.cfg['KEY_NEG_J4']]:
            ...
            if key != self.cmd_prev:
                ...
                if self.cmd_prev in [self.cfg['KEY_POS_J5'], self.cfg['KEY_NEG_J5'], self.cfg['KEY_POS_J4'],
                                     self.cfg['KEY_NEG_J4']]:
                    self.update_alpha()
