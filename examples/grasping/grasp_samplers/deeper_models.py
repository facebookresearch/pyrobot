...
class IfullRobHWNet(ResNet):
    def __init__(self, h_size=128, out_size=n_class,
                 noise_size=n_images, pretrained_resnet18=True,
                 fixed_feature=False,
                 **kwargs):
        ...
        self.fc_noise_1 = nn.Linear(h_size +
                                    self.num_targets * n_robots +
                                    self.num_targets_hw * 2,
                                    h_size)
    ...
    def forward(self, x, robot_one_hot_labels, h, w, full_x, **kwargs):
        ...
        fc_noise_in = torch.cat([fc_noise_0_out,
                                 label_info_mult,
                                 h_info_mult,
                                 w_info_mult], 1)
